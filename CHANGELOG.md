...
The highlight of this release is the new [Rubik's Cube demo](https://github.com/orhun/ratty#rubiks-cube)!
...
| ---------------------------------------------------------------------------------------------------------------------------------------- | ------------------- | ----------------------------------------------------------------------------------------------------------------- |
| [ratty-aarch64-apple-darwin.tar.xz](https://github.com/orhun/ratty/releases/download/v0.4.2/ratty-aarch64-apple-darwin.tar.xz)           | Apple Silicon macOS | [checksum](https://github.com/orhun/ratty/releases/download/v0.4.2/ratty-aarch64-apple-darwin.tar.xz.sha256)      |
| [ratty-x86_64-apple-darwin.tar.xz](https://github.com/orhun/ratty/releases/download/v0.4.2/ratty-x86_64-apple-darwin.tar.xz)             | Intel macOS         | [checksum](https://github.com/orhun/ratty/releases/download/v0.4.2/ratty-x86_64-apple-darwin.tar.xz.sha256)       |
| [ratty-x86_64-pc-windows-msvc.zip](https://github.com/orhun/ratty/releases/download/v0.4.2/ratty-x86_64-pc-windows-msvc.zip)             | x64 Windows         | [checksum](https://github.com/orhun/ratty/releases/download/v0.4.2/ratty-x86_64-pc-windows-msvc.zip.sha256)       |
| [ratty-aarch64-unknown-linux-gnu.tar.xz](https://github.com/orhun/ratty/releases/download/v0.4.2/ratty-aarch64-unknown-linux-gnu.tar.xz) | ARM64 Linux         | [checksum](https://github.com/orhun/ratty/releases/download/v0.4.2/ratty-aarch64-unknown-linux-gnu.tar.xz.sha256) |
| [ratty-x86_64-unknown-linux-gnu.tar.xz](https://github.com/orhun/ratty/releases/download/v0.4.2/ratty-x86_64-unknown-linux-gnu.tar.xz)   | x64 Linux           | [checksum](https://github.com/orhun/ratty/releases/download/v0.4.2/ratty-x86_64-unknown-linux-gnu.tar.xz.sha256)  |

### Features

- Add Rubik's Cube example by @orhun in [#110](https://github.com/orhun/ratty/pull/110)
- Add Nix compatible build files by @DarthPJB in [#61](https://github.com/orhun/ratty/pull/61)
- Embed app icon and set consoleAllocationPolicy=detached for Windows by @sitiom in [#87](https://github.com/orhun/ratty/pull/87)

### Bug Fixes

- Shut down gracefully on window close by @gold-silver-copper in [#108](https://github.com/orhun/ratty/pull/108)
- Make xy plane offset coordinates in 2D mode work like in 3D by @Nomagno in [#86](https://github.com/orhun/ratty/pull/86)
- Reflow terminal contents on resize by @orhun in [#105](https://github.com/orhun/ratty/pull/105)
- Add drag threshold for mouse selection by @orhun in [#104](https://github.com/orhun/ratty/pull/104)
- Report correct window size back to Portable-PTY at all times by @Nomagno in [#96](https://github.com/orhun/ratty/pull/96)

### New Contributors

- @Nomagno made their first contribution in [#86](https://github.com/orhun/ratty/pull/86)
- @DarthPJB made their first contribution in [#61](https://github.com/orhun/ratty/pull/61)
- @sitiom made their first contribution in [#87](https://github.com/orhun/ratty/pull/87)

**Full Changelog**: https://github.com/orhun/ratty/compare/v0.4.1...0.4.2
